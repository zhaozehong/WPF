...
namespace Hexagon.Software.NCGage.HelperLib
{
  public static class DispatcherObjectExternsion
  {
    ...
    public static object SafeCreateInstance(this Type type)
    {
      try
      {
        var dispatcherObject = DispatcherObjectExternsion.GetDefaultDispatcherObject();
    ...
    public static DispatcherObject GetDefaultDispatcherObject()
    {
      return Helpers.IsRuningAsServiceMode ? null : Application.Current;
    }
